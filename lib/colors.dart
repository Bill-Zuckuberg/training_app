...
class AppColor {
  ...
  static Color homePageContainerTextSmall = const Color(0xFFfbfcff);
  static Color homePageContainerTextBig = const Color(0xFFfbfcff);
  ...
  static Color secondPageContainerGradient1stColor = const Color(0xFF6985e8);
  static Color secondPageContainerGradient2ndColor = const Color(0xFF6d7dea);
  static Color secondPageIconColor = const Color(0xFFfafafe);
  static Color loopColor = const Color(0xFF6d7dea);
